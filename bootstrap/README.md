...
bootstrap/
  ...
  backups-credentials.enc.yaml         Secret backups-credentials (no namespace): ACCESS_KEY_ID,
                                       ...
                                       with Postgres by iidp app create/add-capability --postgres (not
                                       applied by anything here: see docs/platform-repository.md)
  sops/
